...
.placeholder img {
 ...
 <div class="container-fluid">
  ...
  <form class="form-horizontal" action="<?php echo U('Goods/doEdit');?>" enctype="multipart/form-data" method="post">
  <input type="hidden" name="id" value="<?php echo ($pro[id]); ?>">
  <div class="form-group">
    <label for="pro_name" class="col-sm-3 control-label">产品名称:</label>
    <div class="col-sm-5">
      <input type="text" class="form-control" value="<?php echo ($pro["pro_name"]); ?>" id="pro_name" name="pro_name" placeholder="产品名称">
    </div>		
  </div>
   <div class="form-group">
  ...
  <div class="form-group">
      ...
      <div class="col-sm-5">
          <input type="text" id="pro_sn" name="pro_sn" value="<?php echo ($pro["pro_sn"]); ?>" class="form-control" placeholder="产品货号">
      </div>
  </div>
  <div class="form-group">
      <label for="pro_subname" class="col-sm-3 control-label">产品副标题:</label>
      <div class="col-sm-5">
          <input type="text" class="form-control" value="<?php echo ($pro["pro_subname"]); ?>" id="pro_subname" name="pro_subname" placeholder="产品副标题">
  ...
  <div class="form-group">
      ...
      <div class="col-sm-5">
          <input type="text" id="market_price" name="market_price" value="<?php echo ($pro["market_price"]); ?>" class="form-control" placeholder="0.00">
      </div>
  </div>
  <div class="form-group">
      <label for="promote_price" class="col-sm-3 control-label">本店价格:</label>
      <div class="col-sm-5">
          <input type="text" id="promote_price" name="promote_price" value="<?php echo ($pro["promote_price"]); ?>" class="form-control" placeholder="0.00">
      </div>
  </div>
  <div class="form-group">
      <label for="stock_num" class="col-sm-3 control-label">库存数量:</label>
      <div class="col-sm-5">
          <input type="text" id="stock_num" name="stock_num" class="form-control" value="<?php echo ($pro["stock_num"]); ?>" placeholder="库存数">
      </div>
  </div>
  <div class="form-group">
      <label for="keywords" class="col-sm-3 control-label">关键字:</label>
      <div class="col-sm-5">
          <input type="text" id="keywords" name="keywords" class="form-control" value="<?php echo ($pro["keywords"]); ?>"  placeholder="关键字">
      </div>
  </div>
   <div class="form-group">
       <label for="description" class="col-sm-3 control-label">描述:</label>
       <div class="col-sm-5">
           <textarea id="description" name="description" class="form-control"  placeholder="产品相关描述"><?php echo ($pro["description"]); ?></textarea>
       </div>
   </div>
   <div class="form-group">
