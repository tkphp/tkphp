    ...
    public function checkLogin() {
        ...
        if ($res) {
            ...
            if ( ! empty($remember)) {
                ...
                cookie('username', $data['username'], array('prefix' => 'blue_', 'expire' => 3600));
                cookie('role_id', $res['role_id'], array('prefix' => 'blue_', 'expire' => 3600));
            ...
            // 登录成功，跳转到主页
            $this->success('欢迎回来：' . $data['username'], U('/Admin/Index/index'));
