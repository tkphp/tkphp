...
class MyController extends Controller {
    ...
    protected function _checkCookie () {
        ...
        if (cookie('blue_symbol') == $blue_symbol) {
            session('id', cookie('blue_id'));
            session('username', cookie('blue_username'));
            session('role_id', cookie('blue_role_id'));
            session('status', cookie('blue_status'));
